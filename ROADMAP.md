...
- [ ] Run `npx create-next-app@latest spark-tutor --typescript --tailwind --eslint --app --src-dir`
- [ ] Copy `.cursorrules` into project root
- [ ] Copy `ROADMAP.md` into project root
- [ ] Verify dev server runs: `npm run dev`
- [ ] Commit: `chore: scaffold next.js project with typescript and tailwind`
...
- [ ] Create `/src/components/child/` folder (add `.gitkeep`)
- [ ] Create `/src/components/parent/` folder (add `.gitkeep`)
- [ ] Create `/src/components/shared/` folder (add `.gitkeep`)
- [ ] Create `/src/lib/firebase/` folder (add `.gitkeep`)
- [ ] Create `/src/lib/claude/` folder (add `.gitkeep`)
- [ ] Create `/src/lib/gemini/` folder (add `.gitkeep`)
- [ ] Create `/src/store/` folder (add `.gitkeep`)
- [ ] Create `/src/types/` folder (add `.gitkeep`)
- [ ] Create `/src/constants/` folder (add `.gitkeep`)
- [ ] Create `/src/hooks/` folder (add `.gitkeep`)
...
- [ ] Install Firebase: `npm install firebase firebase-admin`
...
- [ ] Install Shadcn components: `npx shadcn@latest add card badge button input`
- [ ] Install utility: `npm install clsx tailwind-merge`
...
- [ ] Commit: `chore: add env example file and gitignore check`
...
- [ ] Create `/src/lib/firebase/config.ts` — Firebase client initialization
- [ ] Create `/src/lib/firebase/auth.ts` — Auth helper functions (signIn, signOut, onAuthChange)
- [ ] Create `/src/lib/firebase/firestore.ts` — Firestore helper functions (getSession, saveSummary)
- [ ] Fill in your Firebase project credentials in `.env.local`
- [ ] Verify TypeScript compiles: `npx tsc --noEmit`
- [ ] Commit: `feat(firebase): add firebase client config and auth helpers`
